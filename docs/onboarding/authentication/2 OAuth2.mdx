...
To use OAuth2 with our API, you'll need to grab your **Client ID** and **Client Secret** from the dashboard in your . These keys will let our servers know that your app is legit and allowed to use OAuth2.

To implement OAuth2 on Whop, you will need to register a company on Whop, and head to your [developer settings](https://dash.whop.com/settings?settingsPage=developer) page to obtain your Client ID and Client Secret. These keys will be used to identify your website/app and authenticate it to the Whop API.
