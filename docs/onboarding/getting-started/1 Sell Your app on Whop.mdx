...
By the end, you'll have a project that allows users to go on, pay, and use a simple calculator.

If you prefer, you can fork our [Github](https://tbd-github.com) to explore the code directly.
