...
- If you don't want to bother with RESTful requests and just want to dive in to some code, our [NextJS Template App](/nextjs) is an easy solution. Built on the lastest version of NextJS, this template app is already optimized for integrations with Whop (using our JavaScript and Typescript SDK), letting you focus on what's important to your customers
