---
slug: /sell-access/getting-started
...
- If you want to setup integrations with Whop to start collecting payments **fast**, we recommend checking out our [Webhook Integration guide](/sell-access/integrate-via-webhooks)
- If you're looking to build out a more in-depth integration for your users, our [OAuth/API Integration guide](/sell-access/integrate-via-api) will lead you through every step of setting up a project using Whop OAuth and API
  ...
  <div className="row" style={{ marginBottom: 64 }}>
    <div className="col col--4" key={0} style={{ padding: 8 }}>
      <ProductCard
        ...
        link={"/sell-access/integrate-via-webhooks"}
      />
    </div>
    <div className="col col--4" key={1} style={{ padding: 8 }}>
      <ProductCard
        ...
        link={"/sell-access/integrate-via-api"}
      />
    </div>
  </div>
</div>
